const Impressum = () => {
  return (
    <div className="container">
      ...
      <br />
      <p>
        § 2 Externe Links Diese Website enthält Verknüpfungen zu Websites
      ...
      <br />
      <p>
        § 4 Besondere Nutzungsbedingungen Soweit besondere Bedingungen für
        einzelne Nutzungen dieser Website von den vorgenannten Paragraphen
        abweichen, wird an entsprechender Stelle ausdrücklich darauf
